...
import { selectpieIndiceDesercion } from '../../../store/DashGeneralStore/HighchartStore/HighchartFenomenos'
...
export default function LineVariableIndependiente() {
    ...
    pieIndiceDesercion.series = prepieIndiceDesercion.series

    return (
        <HighchartsReact
            highcharts={Highcharts}
            options={pieIndiceDesercion}
        />
    )
